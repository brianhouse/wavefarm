...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 510.0, 165.0, 59.5, 20.0 ],
					"id" : "obj-5",
					"fontname" : "Arial",
					"numinlets" : 3,
					"presentation_rect" : [ 504.0, 162.0, 0.0, 0.0 ],
					"numoutlets" : 4,
					"fontsize" : 12.0
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 450.0, 330.0, 20.0, 47.0 ],
					"id" : "obj-25",
					"numinlets" : 2,
					"numoutlets" : 2
				}
...
, 			{
				"box" : 				{
					"maxclass" : "gain~",
					"outlettype" : [ "signal", "int" ],
					"patching_rect" : [ 435.0, 330.0, 20.0, 47.0 ],
					"id" : "obj-24",
					"numinlets" : 2,
					"numoutlets" : 2
				}
...
, 			{
				"box" : 				{
					...
					"text" : "route 1 10",
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 735.0, 90.0, 65.0, 20.0 ],
					"id" : "obj-19",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 3,
...
, 			{
				"box" : 				{
					...
					"text" : "route 1 10",
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 615.0, 90.0, 65.0, 20.0 ],
					"id" : "obj-12",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 3,
...
, 			{
				"box" : 				{
					...
					"text" : "$2 $3 $1",
					"outlettype" : [ "" ],
					"patching_rect" : [ 105.0, 240.0, 57.0, 18.0 ],
					"id" : "obj-8",
					"fontname" : "Arial",
					"numinlets" : 2,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "route 1 15",
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 75.0, 135.0, 65.0, 20.0 ],
					"id" : "obj-3",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 3,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "noteout",
					"patching_rect" : [ 105.0, 270.0, 51.0, 20.0 ],
					"id" : "obj-6",
					"fontname" : "Arial",
					"numinlets" : 3,
					"numoutlets" : 0,
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 84.5, 159.5, 444.5, 159.5 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-5", 0 ],
					"hidden" : 0,
					"midpoints" : [ 107.5, 159.5, 519.5, 159.5 ]
				}
