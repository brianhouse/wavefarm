...
TUNING = [None, B1, E1, E2, Ab3, D3, None, A2, Db3]  # alt  # 5 1 1 3 7 2 4 6
TUNING = [None, None, E1, E2, Ab3, D3, None, A2, Db3]  # alt  # 5 1 1 3 7 2 4 6
...
tide = BasicMidi(2)
tide.tween('tempo', RANGE[0], RANGE[1], DURATION, get_signal_f(data['sun']))    # tide->sun
